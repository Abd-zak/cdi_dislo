...
def make_gif_module_phase_strain_tilt(
    module_ortho,
    phase_ortho,
    strain,
    tilt_comp1,
    ...
    vmax_strain=None,
    fw=4,
    name="gif_default_name",
    duration=10,
):
    vmin_list = [
        np.nanmin(module_ortho),
...
def make_gif_pixels_3d(
    ...
    verts, faces, normals, values = measure.marching_cubes(
        module_ortho, iso_val, spacing=(0.1, 0.1, 0.1)
    )
...
@gif.frame
def Gif_one_slice_schematic_Bragg_planes(
    displacement,
    qcen,
    voxel_sizes,
    slice_index,
...
def make_gif_schematic_Bragg_planes(
    displacement,
    qcen,
    voxel_sizes,
    strain=None,
    ...
    frames = [
        Gif_one_slice_schematic_Bragg_planes(
            displacement,
            qcen,
            voxel_sizes,
            slice_index,
...
@gif.frame
def Gif_one_image(array, n, log_scale=False, fw=4):
    if n % 10 == 0:
...
def make_gif_array3d(
    array, name="gif_default_name", duration=10, log_scale=False, fw=6
):
    frames = [
