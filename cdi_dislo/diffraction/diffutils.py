...
def get_abc_direct_space(cx, cy, cz, cx0, cy0, cz0, wanted_shape=None):
    ...
    p0_x, p0_y, p0_z = (
        ...
        0,
        0,
    )  # p0_x,p0_y,p0_z=cx0_-tayx//2,cy0_-tayy//2,cz0_-tayz//2
    p1_x, p1_y, p1_z = (
        -1,
        0,
        0,
    )  # p1_x,p1_y,p1_z=cx0_+tayx//2,cy0_-tayy//2,cz0_-tayz//2
    p2_x, p2_y, p2_z = (
        0,
        -1,
        0,
    )  # p2_x,p2_y,p2_z=cx0_-tayx//2,cy0_+tayy//2,cz0_-tayz//2
    p3_x, p3_y, p3_z = (
        0,
        0,
        -1,
...
def ortho_data_phaserho_sixs2019(
    ...
    for i_scan in scan_nb:
        ...
        nx, dif_x = optimize_voxel_real_space(
            ...
            89 - 80,
            89 + 5,
            voxel_to_found=best_voxel_size,
        )
        ny, dif_y = optimize_voxel_real_space(
            a,
            b,
        ...
        if plot_:
            ...
            fig3.text(
                0.60,
                0.40,
                "Bulk - isosurface=" + str("{:.2f}".format(0.5)),
                size=20,
            )
        ...
        np.savez(
            save__orth + scan + "/S" + str(scan) + "s_results.npz",
            **{
                "amp": density_ortho,
                "phase": phase_ortho,
                "bulk": bulk,
